...
export default function About() {
  return (
    <section className={`py-16 mt-10  ${inter.className}`}>
...
/>
  ...
  {/* IMAGE PRINCIPALE (décalée gauche propre) */}
...
<div className="absolute top-[42%] left-[42%] -translate-x-1/2 -translate-y-1/2 w-[130px] h-[130px] flex items-center justify-center z-30">
  ...
  <div className="absolute inset-0 animate-spin-slow flex items-center justify-center">
    <svg viewBox="0 0 100 100" className="w-full h-full rotate-[-90deg]">
      ...
      <text
        fill="black"
        fontSize="7"         // 🔥 plus grand
        letterSpacing="1.2"  // 🔥 un peu réduit (plus propre)
        fontWeight="900"     // 🔥 plus bold
      >
...
{/* BADGE */}
<div className="absolute -left-20 bottom-17 bg-slate-900 text-white px-6 py-6 rounded-xl flex items-center gap-3 shadow-xl ring-2 ring-white z-30">
...
<div className="flex items-center gap-1.5 mb-2">
  ...
  <p className="text-[#505361] font-medium text-sm">
    Perfume Exhibition
  </p>
...
<p className="text-gray-600 mb-6 leading-relaxed">
  ...
  <div className="space-y-4">
    ...
    <div className="bg-gray-100 p-5 rounded-xl flex gap-4 items-center">
      <div className="bg-[#1E1E22] text-white p-3 rounded-lg">
        <Layers size={20} />
      </div>
      <div>
        <h3 className="font-semibold">Premium Brand Showcases</h3>
    ...
    <div className="bg-gray-100 p-5 rounded-xl flex gap-4 items-center">
      ...
      <div>
        <h3 className="font-semibold">Immersive Fragrance Experience</h3>
        <p className="text-sm text-gray-600">
...
<button className="group flex items-center gap-3 bg-[#FFC400] text-black px-6 py-3 rounded-full font-semibold transition hover:opacity-90">
  ...
  <div className="flex items-center gap-3">
    ...
    <div>
      ...
      <p className="text-sm text-gray-500">+90 538 507 39 47</p>
    </div>
  </div>
